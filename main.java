...
public MyPanel() {
            ...
            try{
                ...
                while ((linea=br.readLine())!=null){
                    if (!linea.equals(" ")){
                        ...
                        if(informacion_usuario_inicio.equals(informacion_usuario_registro) && informacion_contra_inicio.equals(informacion_contrasena_registro)){
    ...
    if (e.getSource() == adopcion_boton) {
        ...
        if(!found){
            System.out.println("No tenemos mascota con esas caracteristicas, intenta con otras"+"\n");
        }
    }
    catch (Exception ex) {
        ex.printStackTrace();
